...
async function main() {
  ...
  function registerButton(button: typeof ButtonList) {
    ...
    if (button.Button.label == "Spicy Lyrics" || button.Button.icon == Icons.LyricsPage || storage.get("replace_lyrics_button") == "true") document.querySelector(".main-nowPlayingBar-lyricsButton")?.replaceWith(button.Button.element);
  }
